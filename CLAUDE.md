...
- Monthly-only contracts (every stock, FINNIFTY, MIDCPNIFTY) often have an untraded second month, so the bhavcopy history may lack a 30-day reading on many dates for them. The importer's "CM30 days" column shows the coverage per symbol.
